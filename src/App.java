...
public class App {
    ...
    public App(String pUsername) {
        ...
        while(true) {
            ...
            System.out.println("[3] Neuste Nachricht (" + this.countNewMessages + ")");
            System.out.println("[4] Neuste Nachrichten löschen");
    ...
    public void deleteNotifications() {
        while(newMessages.isEmpty() == false) {
            newMessages.dequeue();
        }
        this.countNewMessages = 0;
    }
    ...
    public void showNotifications() {
        if (!this.newMessages.isEmpty()) {
            Message message = this.newMessages.front();
            System.out.println(message.toString(this.cipher, this.secretKey));
